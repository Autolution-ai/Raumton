...
const PROBLEMS = [
  {
    ...
    stat: '>55 dB',
    beschreibung:
      'Ab diesem Lärmpegel sinkt die Konzentration messbar. Die meisten Mitarbeiter gewöhnen sich daran – und merken erst im Vergleich, wie viel Energie der Lärm sie jeden Tag kostet.',
  },
  {
    icon: Utensils,
  ...
  },
  {
    ...
    stat: '-40% Verständnis',
    beschreibung:
      'Wer im Meeting dreimal nachfragen muss, verliert den Faden. Schlechte Sprachverständlichkeit kostet Zeit – und hinterlässt den falschen Eindruck beim Kunden.',
  },
]
