...
const PROBLEMS = [
  {
    ...
    text: 'Lärmpegel über 55 dB reduzieren die kognitive Leistungsfähigkeit nachweislich. Ihre Mitarbeiter zahlen täglich den Preis.',
  },
  {
    label: 'Restaurant & Gastronomie',
    stat: '–23 %',
    statLabel: 'weniger Umsatz',
    text: 'Studien zeigen: Gäste konsumieren weniger und gehen früher, wenn die Lautstärke als störend empfunden wird.',
  },
  {
    label: 'Konferenzraum',
    stat: '40 %',
    statLabel: 'mehr Missverständnisse',
    text: 'Schlechte Sprachverständlichkeit in Meetings kostet Entscheidungen, Zeit und Nerven — messbar und vermeidbar.',
  },
]
