        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            <motion.p variants={fadeUp} className="text-[#A0A0A0] leading-relaxed mb-4">
              Ulli Müller gründete raumton 2006 als Audiotechniker und Studiobauer – mit
              dem Gedanken, dass gute Akustik nicht nur in Rundfunkhäusern und
              Tonstudios funktionieren muss. Was klein begann, wurde zur gefragten Adresse
              für Büros, Restaurants und Bildungseinrichtungen in ganz Berlin.
            </motion.p>
            <motion.p variants={fadeUp} className="text-[#A0A0A0] leading-relaxed mb-8">
              Seit 2022 führt Leo Ripper das Unternehmen in zweiter Generation. Neue
              Energie – aber dieselbe Überzeugung: Akustik, die funktioniert, und
              Lösungen, die wirklich zum Raum passen. Nicht von der Stange, sondern
              gemessen, geplant und in Berlin-Schöneberg gefertigt.
            </motion.p>
