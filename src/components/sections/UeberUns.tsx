      ...
      <div className="container-wide">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          >
            <div className="relative h-[500px] lg:h-[600px] overflow-hidden">
              <Image
                ...
                alt="raumton Werkstatt Berlin-Schöneberg"
                fill
          ...
          >
            ...
            >
              Berliner Handwerk.{' '}
              <span className="text-gradient-gold">Seit 2006.</span>
            </motion.h2>
            <motion.p variants={fadeUp} className="text-[#A0A0A0] leading-relaxed mb-4">
              raumton wurde 2006 von Ulli Müller gegründet – einem Audiotechniker und
              Studiobauer, der die Kraft guter Raumakustik aus erster Hand kannte. Was
              als Spezialist für Tonstudios begann, wurde zur gefragten Adresse für
              Büros, Gastronomie und öffentliche Einrichtungen in Berlin und weit darüber
              hinaus.
            </motion.p>
            <motion.p variants={fadeUp} className="text-[#A0A0A0] leading-relaxed mb-8">
              ...
              Philosophie bleibt dieselbe: Individuelle Lösungen. Berliner Qualität.
              Kein Kompromiss zwischen Funktion und Design.
            </motion.p>
