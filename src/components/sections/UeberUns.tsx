      ...
      <div className="container-wide" ref={ref}>
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div>
            ...
            >
              Berliner Manufaktur. Echtes Handwerk.
            </motion.h2>
            ...
            >
              <p>
                Ulli Müller gründete raumton 2006 aus einer einfachen Überzeugung: Gute Raumakustik sollte für jeden zugänglich sein – nicht nur für Tonstudios und Rundfunkhäuser. Als Audiotechniker und Studiobauer kannte er die Kraft des guten Klangs.
              </p>
              <p>
                Seit 2022 führt Leo Ripper das Unternehmen in zweiter Generation. Die Fertigung liegt noch immer in Berlin-Schöneberg. Das Prinzip ist dasselbe geblieben: erst zuhören, dann messen, dann liefern.
              </p>
            </motion.div>
