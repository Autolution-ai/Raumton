        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          >
            ...
            <motion.p variants={fadeUp} className="text-[#A0A0A0] leading-relaxed mb-10">
              Farben und Materialien überzeugen erst, wenn man sie anfasst. Im Showroom
              liegen alle unsere Musterplatten aus – über 300 Farben und Texturen.
              Kommen Sie vorbei oder rufen Sie kurz an, wir sind Mo–Fr von 9 bis 18 Uhr da.
            </motion.p>
