        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          >
            ...
            >
              ...
              <span className="text-gradient-gold">in Berlin-Schöneberg.</span>
            </motion.h2>
            <motion.p variants={fadeUp} className="text-[#A0A0A0] leading-relaxed mb-10">
              Nicht jeder Schallabsorber überzeugt auf dem Bildschirm. Im Showroom können Sie
              alle unsere Produkte anfassen, die Qualität beurteilen und über 300 Farben
              und Texturen in Augenschein nehmen. Vereinbaren Sie einfach einen Termin.
            </motion.p>
          ...
          >
            <iframe
              ...
              title="raumton Showroom Berlin-Schöneberg"
            />
